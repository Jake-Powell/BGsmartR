...
#'
#'This function can be used to create the turnover report of a living collection. The report produces interactive or static graphs (bars, pies) detailing the gain and loss of items/accessions/taxa/families over time whilst also considering the type of taxa (native, endemic, threatened) in the LC.
#'
#'@inheritParams create_native_report
#'
#' @export
#'
create_turnover2_report <- function(enriched_report,
                                      collection = NULL,
                                      min_year = 1970,
