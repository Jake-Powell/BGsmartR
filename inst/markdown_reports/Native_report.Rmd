...
# collection = 'LC'
# load('/Users/jakepowell/Cambridge/Enriched_reports_Jake/Desert_enriched_report.rda')
# coordinates = c(33.461822709203425, -111.944936728836)
...
if(length(location_name) == 0){
  stop('Given co-ordinates do not belong to any over the regions in  wgsrpd3!')
}
```
...
`r if(do_over_time){"Next we show how the number of native plants in the LC has varied over time."}`
...
```{r, Among the native plants in a LC, how many of them are endemic or redlisted - get important taxa, echo = FALSE, ft.keepnext = FALSE}
...
```{r, Among the native plants in a LC, how many of them are endemic or redlisted - table, ft.keepnext = FALSE}
if(report_kind == 'static'){
  data_compressed |>
  flextable() |>
