...
```
<!-- # Only actually need is AccNoFull, no_gardens. -->
...
<!-- Create `report_trend` to be used in trend analyses` -->
```{r, restructure enriched report, child= paste0(system.file(package = "BGSmartR"), "/report_parts/prepare_trend_data.Rmd")}
```

```{r, Extracting required information from enriched report, echo = F, eval = F}
# Setup specific for trends report.
...
#                        ItemStatusType = report_trend$ItemStatusType,post_date = '3000-01-01')
# 
...
colours = c('#f46d43', "#FDAE6B", '#848484', '#e6e6e6')
fig <- plot_ly(time_series_info_normalised, x = ~years)
