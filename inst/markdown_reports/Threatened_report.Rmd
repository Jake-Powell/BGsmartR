...
Next we split the threatened plants in the living collection into their respectively red list category.
...
`r if(do_over_time){"Next we view threatened plants in the living collection as a percentage of all plants in the living collection over time."}`
...
names(no_more_info) = c('Taxonomic name and author', 'Last year in collection', 'Total years in collection', 'In collection history', 'Threatened', 'Threatened category', 'Endemic', 'Naive', 'Tree')
...
In the living collection's history there are `r nrow(no_more_info)` threatened taxa which are no longer present. These are outlined below, ordered by how recently the taxa was present in the living collection.
...
`r if(report_kind == 'interactive'){"#####  Provenance of threatened species in the living collection {.tabset}"}`
...
`r if(report_kind == 'interactive'& do_over_time){"#####  Provenance of threatened species in the Living collection over time {.tabset}"}`
