...
```{r, imported parameters, eval  =FALSE}
...
threatened_existing = threatened[threatened$ItemStatusType == 'Existing',] 
...
threatened_accessions = threatened_accessions[,match(c('AccNoFull', 'TaxonNameFull', 'powo_name', 'threatened', 'threatened_category', 'endemic', 'geography_codes', 'ProvenanceCode'), names(threatened_accessions))]
names(threatened_accessions) = c('Accession Number', 'Original Taxonomic Name and Author', 'POWO Taxonomic Name and Author', 'Threatened', 'Red list category', 'endemic', 'Geographic codes..', 'Provenance')
writexl::write_xlsx(threatened_accessions, path =paste0(output_dir,'/',collection,'_threatened_accessions_list.xlsx'))


```

### How many threatened species are in the LC and where are they from?

In the LC there are `r format(no_threatened_items_existing, big.mark=',')` items corresponding to  `r format(no_threatened_accessions_existing, big.mark=',')` accessions of existing threatened plants. The number of threatened species existing in the LC is summarised below.
...
Next we produce maps showing where in the world the threatened plants in the LC are from. 
...
text = paste0('Region: ', plot_int_info$name, '<br />', 
              ...
              '# Species in LC: ', plot_int_info$no_threatened_species,
...
### Duplication of threatened species in the LC
...
In this section, we explore the duplication of threatened species in the LC. 

We produce pie charts showing the number of items/accessions each threatened taxa has in the LC. 
...
```{r  Duplication of existing threatened items in the LC - interactive, fig.fullwidth=TRUE, fig.dim = c(10, 6), eval = report_kind == 'interactive'}
...
```{r  Duplication of existing threatened accessions in the LC - interactive, fig.fullwidth=TRUE, fig.dim = c(10, 6), eval = report_kind == 'interactive'}
...
if(separate_figure_folder){
  htmlwidgets::saveWidget(fig, file = paste0(figures_dir, '/','Pie-duplication_threatened_accessions.html'))
}
...
### What proportion of the LC at `r collection` is threatened and how has this varied over time?
...
```{r  Number of threatened items over time in the LC - interactive, fig.fullwidth=TRUE, fig.dim = c(10, 6), eval = report_kind == 'interactive' & do_over_time}
i=1
to_do = c('Items', 'Accessions', 'Taxa', 'Species')
titles = c('items', 'accessions', 'taxa', 'species')
...
if(separate_figure_folder){
  htmlwidgets::saveWidget(fig, file = paste0(figures_dir, '/','line-number_of_threatened_',titles[i],'__over_time.html'))
}

```

`r if(report_kind == 'interactive' & do_over_time){"###### Accessions"}`
```{r  Number of threatened accessions over time in the LC - interactive, fig.fullwidth=TRUE, fig.dim = c(10, 6), eval = report_kind == 'interactive' & do_over_time}
i=2
to_do = c('Items', 'Accessions', 'Taxa', 'Species')
titles = c('items', 'accessions', 'taxa', 'species')
...
```{r  Number of threatened taxa over time in the LC - interactive, fig.fullwidth=TRUE, fig.dim = c(10, 6), eval = report_kind == 'interactive' & do_over_time}
i=3
to_do = c('Items', 'Accessions', 'Taxa', 'Species')
titles = c('items', 'accessions', 'taxa', 'species')
...
```{r  Number of threatened species over time in the LC - interactive, fig.fullwidth=TRUE, fig.dim = c(10, 6), eval = report_kind == 'interactive' & do_over_time}
i=4
to_do = c('Items', 'Accessions', 'Taxa', 'Species')
titles = c('items', 'accessions', 'taxa', 'species')
...
for(i in 1:length(to_do)){
  ...
  plot_dataB = data.frame(date =years, 
                          percent = 100-percent,
                          represented = rep('Non-Threatened', length(date)))
  
  plot_data = rbind(plot_dataA, plot_dataB)
  plot_data$represented = factor(plot_data$represented,levels = c('Non-Threatened','Threatened'))
...
`r if(report_kind == 'interactive' & do_over_time){"###### Items"}`
```{r  Proportion of threatened items over time in the LC - interactive, fig.fullwidth=TRUE, fig.dim = c(10, 6), eval = report_kind == 'interactive' & do_over_time}
i=1
to_do = c('Items', 'Accessions', 'Taxa', 'Species')
titles = c('items', 'accessions', 'taxa', 'species')
...
if(separate_figure_folder){
  htmlwidgets::saveWidget(fig, file = paste0(figures_dir, '/','Stacked_bar-percentage_of_threatened',titles[i],'__over_time.html'))
}

```

`r if(report_kind == 'interactive' & do_over_time){"###### Accessions"}`
```{r  Proportion of threatened accessions over time in the LC - interactive, fig.fullwidth=TRUE, fig.dim = c(10, 6), eval = report_kind == 'interactive' & do_over_time}
i=2
to_do = c('Items', 'Accessions', 'Taxa', 'Species')
titles = c('items', 'accessions', 'taxa', 'species')
...
`r if(report_kind == 'interactive' & do_over_time){"###### Taxa"}`
```{r  Proportion of threatened taxa over time in the LC - interactive, fig.fullwidth=TRUE, fig.dim = c(10, 6), eval = report_kind == 'interactive' & do_over_time}
i=3
to_do = c('Items', 'Accessions', 'Taxa', 'Species')
titles = c('items', 'accessions', 'taxa', 'species')
...
`r if(report_kind == 'interactive' & do_over_time){"###### Species"}`
```{r  Proportion of threatened species over time in the LC - interactive, fig.fullwidth=TRUE, fig.dim = c(10, 6), eval = report_kind == 'interactive' & do_over_time}
i=4
to_do = c('Items', 'Accessions', 'Taxa', 'Species')
titles = c('items', 'accessions', 'taxa', 'species')
...
if(separate_figure_folder){
  htmlwidgets::saveWidget(fig, file = paste0(figures_dir, '/','Stacked_bar-percentage_of_threatened',titles[i],'_over_time.html'))
}
...
### Provenance of threatened plants in the LC
  
  In this section we are exploring the provenance of threatened plants in the collection. We shall do this in two parts: existing plants in the LC and how this has changed over time.

Below we produce a table of provenance for items and accessions.

```{r, Provenance of threatened plants in the LC}
# LC_native_exisiting the data of existing threatened plants in the LC. 
...
`r if(report_kind == 'interactive'){"###### Items"}`
```{r  Provenance of existing threatened items in the LC - interactive, fig.fullwidth=TRUE, fig.dim = c(10, 6), eval = report_kind == 'interactive'}
text = paste0(prov_items$Items, ' threatened items with provenance "', prov_items$Provenance, '"')
...
if(separate_figure_folder){
  htmlwidgets::saveWidget(fig, file = paste0(figures_dir, '/','Pie-provenance_threatened_items.html'))
}
...
`r if(report_kind == 'interactive'){"###### Accessions"}`
```{r  Provenance of existing threatened accessions in the LC - interactive, fig.fullwidth=TRUE, fig.dim = c(10, 6), eval = report_kind == 'interactive'}
text = paste0(prov_accessions$Accessions, ' threatened accessions with provenance "', prov_accessions$Provenance, '"')
...
if(separate_figure_folder){
  htmlwidgets::saveWidget(fig, file = paste0(figures_dir, '/','Pie-provenance_threatened_accessions.html'))
}
...
`r if(report_kind == 'interactive'& do_over_time){"###### Items"}`
```{r  Provenance of threatened items over time in the LC - interactive, fig.fullwidth=TRUE, fig.dim = c(10, 6), eval = report_kind == 'interactive'& do_over_time}
to_do = c('items', 'accessions')
i=1
...
`r if(report_kind == 'interactive'& do_over_time){"###### Accessions"}`
```{r  Provenance of threatened accessions over time in the LC - interactive, fig.fullwidth=TRUE, fig.dim = c(10, 6), eval = report_kind == 'interactive'& do_over_time}
to_do = c('items', 'accessions')
i=2
...
### Survival of threatened plants in the LC 
...
native_non_native = enriched_report$threatened
...
p = ggsurvfit::survfit2(survival::Surv(time, Alive_dead) ~ threatened_status, data = data_to_analyse) |> 
  ggsurvfit::ggsurvfit() +
  ggplot2::labs(
    x = "Years",
...
if(report_kind == 'static'){
  if(separate_figure_folder){
  ggplot2::ggsave(plot = p, filename = paste0(figures_dir, '/','threatened_Non-Threatened_survival.pdf'),device = 'pdf', scale = 1, limitsize = FALSE)
  }
  p
} 
```
...
# 
ggsurvfit::survfit2(survival::Surv(time, Alive_dead) ~ threatened_status, data = data_to_analyse) |> 
