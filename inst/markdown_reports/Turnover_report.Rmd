...
In the net graphs we overlap the graphs with the relevant overall trend to be able to visualise how the turnover affects the total number of `r tolower(data_type)` over time. The trends are calculated by looking at the `r tolower(data_type)` that are existing on the 31st of December each year. 
