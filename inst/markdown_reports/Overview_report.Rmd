...
```{r, Map represented areas by number of species (entire collection; Geography module),  fig.fullwidth=TRUE, fig.dim = c(10, 6), eval = report_kind == 'interactive'}
interest = report[report$ItemStatusType == 'Existing',]
...
#### Gained accessions split by provenance over time
