...
This report combines key figures from modules across BGSmartR into a single document.

Further detail can be found by running other modules.  
...
```{r, overlap important,results='hide',fig.keep='all', message=FALSE, fig.dim=c(6,6), fig.align = 'center', eval = report_kind == 'interactive'}
# Select wanted data and add needed columns
interest = report[report$ItemStatusType == 'Existing',]
interest = interest[!interest$taxon_type |> is.na(),]
