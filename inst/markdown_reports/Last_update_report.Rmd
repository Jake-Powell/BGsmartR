...
interest = report[,match(c('AccNoFull','best_name', 'sanitised_taxon', 'extracted_author', 'ItemAccNoFull', 'ItemStatusDate'), names(report))]
...
missing_index = which(report$ItemStatusDate == '' | is.na(report$ItemStatusDate))
