...
load('/Users/jakepowell/Cambridge/Enriched reports/Cooktown_enriched_report.rda')
report = enriched_report
collection = 'Cooktown'
min_year = NULL


min_year_report = min(enriched_report$AccYear[enriched_report$AccYear>1750],na.rm = T)

if(is.null(min_year)){
  min_year =  min_year_report 
}
if(min_year < min_year_report){
   min_year =  min_year_report 
}
...
report = report[!is.na(report$AccYear),]
...
#   infrageneric_level = current$infrageneric_level[1]
#   taxa = paste0(current$sanitised_taxon[1], ' ', current$extracted_author[1])
...
#   }
#   return(c(AccNoFull, taxa, AccYear, no_items, no_existing, DeathDate,
#            ProvenanceCode, POWO_redlist_category, endemic, infrageneric_level))
# })
# 
# accessions = data.frame(t(data.frame(accessions_data)))
# names(accessions) = c('AccNoFull', 'Taxa', 'AccYear', 'no_items', 'no_existing', 'DeathDate',
#            'ProvenanceCode', 'POWO_redlist_category', 'endemic', 'infrageneric_level')
...
data_percent[is.nan(as.matrix(data_percent))] = 0 #Set percent to 0 for years with no accessions.
...
fig4 <- fig4 %>% layout(title = "",
         ...
         yaxis = list (title = "Proportion of Accessions"),
          barmode = 'stack')
fig4 <- fig4 %>% layout(hovermode = 'x unified', yaxis = list(ticksuffix = '%'), bargap=0)
...
# Stacked bar graph
fig4 <- plot_ly(new_accessions_df, x = ~year)
fig4 <- fig4 %>% add_trace(y = ~Endemic, type='bar', name = 'Endemic',  marker = list(color = colours[1], line = list(color = 'rgb(8,48,107)', width = 0)))
fig4 <- fig4 %>% add_trace(y = ~Not_endemic, type='bar',name = 'Widespread',  marker = list(color = colours[2], line = list(color = 'rgb(8,48,107)', width = 0)))
fig4 <- fig4 %>% layout(title = "",
         xaxis = list(title = "Year"),
         yaxis = list (title = "Number of Accessions"),
          barmode = 'stack')
...
new_accessions_df$endemic_prop[is.nan(new_accessions_df$endemic_prop)] = 0
new_accessions_df$not_endemic_prop = round(new_accessions_df$Not_endemic/new_accessions_df$Total*100, digits=2)
new_accessions_df$not_endemic_prop[is.nan(new_accessions_df$not_endemic_prop)] = 0
...
fig3 <- plot_ly(new_accessions_df, x = ~year, y = ~endemic_prop, name = 'Endemic', type = 'bar', marker = list(color = colours[1], line = list(color = 'rgb(8,48,107)', width = 0)))
fig3 <- fig3 %>% add_trace(y = ~not_endemic_prop, name = 'Widespread', marker = list(color = colours[2], line = list(color = 'rgb(8,48,107)', width = 0)))
fig3 <- fig3 %>% layout(title = "",
         xaxis = list(title = "Year"),
         yaxis = list (title = "Proportion of Accessions"),
          barmode = 'group')
...
fig4 <- plot_ly(new_accessions_df, x = ~year, y = ~endemic_prop, name = 'Endemic', type = 'bar', marker = list(color = colours[1], line = list(color = 'rgb(8,48,107)', width = 0)))
fig4 <- fig4 %>% add_trace(y = ~not_endemic_prop, name = 'Widespread', marker = list(color = colours[2], line = list(color = 'rgb(8,48,107)', width = 0)))
fig4 <- fig4 %>% layout(title = "",
         xaxis = list(title = "Year"),
         yaxis = list (title = "Proportion of Accessions"),
          barmode = 'stack')
...
# Bar graph
fig3 <- plot_ly(new_accessions_df, x = ~year)
fig3 <- fig3 %>% add_trace(y = threatened, type = 'bar', name = 'Threatened', marker = list(color = colours[1],line = list(color = 'rgb(8,48,107)', width = 0)))
fig3 <- fig3 %>% add_trace(y = not_threatened, type = 'bar', name = 'Not Threatened', marker = list(color = colours[2],line = list(color = 'rgb(8,48,107)', width = 0)))
fig3 <- fig3 %>% layout(title = "",
         xaxis = list(title = "Year"),
         yaxis = list (title = "Number of Accessions"),
          barmode = 'group')
...
# Stacked bar graph
fig4 <- plot_ly(new_accessions_df, x = ~year)
fig4 <- fig4 %>% add_trace(y = threatened, type='bar', name = 'Threatened',  marker = list(color = colours[1], line = list(color = 'rgb(8,48,107)', width = 0)))
fig4 <- fig4 %>% add_trace(y = not_threatened, type='bar',name = 'Not Threatened',  marker = list(color = colours[2], line = list(color = 'rgb(8,48,107)', width = 0)))
fig4 <- fig4 %>% layout(title = "",
         xaxis = list(title = "Year"),
         yaxis = list (title = "Number of Accessions"),
          barmode = 'stack')
...
threatened_prop[is.nan(threatened_prop)] = 0
not_threatened_prop = round(not_threatened/new_accessions_df$Total*100,digits=2)
not_threatened_prop[is.nan(not_threatened_prop)] = 0
...
# Bar graph
fig3 <- plot_ly(new_accessions_df, x = ~year)
fig3 <- fig3 %>% add_trace(y = threatened_prop, type = 'bar', name = 'Threatened', marker = list(color = colours[1],line = list(color = 'rgb(8,48,107)', width = 0)))
fig3 <- fig3 %>% add_trace(y = not_threatened_prop, type = 'bar', name = 'Not Threatened', marker = list(color = colours[2],line = list(color = 'rgb(8,48,107)', width = 0)))
fig3 <- fig3 %>% layout(title = "",
         xaxis = list(title = "Year"),
         yaxis = list (title = "Proportion of Accessions"),
          barmode = 'group')
...
# Stacked bar graph
fig4 <- plot_ly(new_accessions_df, x = ~year)
fig4 <- fig4 %>% add_trace(y = threatened_prop, type='bar', name = 'Threatened',  marker = list(color = colours[1], line = list(color = 'rgb(8,48,107)', width = 0)))
fig4 <- fig4 %>% add_trace(y = not_threatened_prop, type='bar',name = 'Not Threatened',  marker = list(color = colours[2], line = list(color = 'rgb(8,48,107)', width = 0)))
fig4 <- fig4 %>% layout(title = "",
         xaxis = list(title = "Year"),
         yaxis = list (title = "Proportion of Accessions"),
          barmode = 'stack')
...
fig4 <- plot_ly(threat_data, x = ~year, y=~value, type = 'bar', color = ~variable, 
              marker = list(color = ~colours, line = list(color = 'rgb(8,48,107)', width = 0)))
fig4 <- fig4 %>% layout(title = "",
         xaxis = list(title = "Year"),
         yaxis = list (title = "Number of Accessions"),
          barmode = 'stack')
