---
title: "Retrospective Overview of the Collection - Lost Accessions"
...
In this section we look at how the composition of lost accessions varies. Where the date an accession is lost is the date when the last item in the accession is classed as 'Not Existing'.
...
#### Number of Lost Accessions each Year
...
if(save_widgets){
  htmlwidgets::saveWidget(fig, file = paste0(lost_accessions_widget_dir,'/Bar_no_accessions.html'),selfcontained = T)
}
...
#### Number of Species Lost Accessed Each Year
...
if(save_widgets){
  htmlwidgets::saveWidget(fig, file = paste0(lost_accessions_widget_dir,'/Bar_no_species.html'),selfcontained = T)
}
...
***
#### Number of Families Lost Accessed Each Year
...
if(save_widgets){
  htmlwidgets::saveWidget(fig, file = paste0(lost_accessions_widget_dir,'/Bar_no_families.html'),selfcontained = T)
}
...
#### Number of Genera Lost Accessed Each Year
...
if(save_widgets){
  htmlwidgets::saveWidget(fig, file = paste0(lost_accessions_widget_dir,'/Bar_no_genera.html'),selfcontained = T)
}
...
### Number of Lost Accessions by species, infraspecific, and cultivars each year
...
if(save_widgets){
  htmlwidgets::saveWidget(fig, file = paste0(lost_accessions_widget_dir,'/number_species_infraspecific_and_cultivars.html'),selfcontained = T)
}
...
if(save_widgets){
  htmlwidgets::saveWidget(fig, file = paste0(lost_accessions_widget_dir,'/proportion_species_infraspecific_and_cultivars.html'),selfcontained = T)
}
...
### Distribution and Number of Lost Accessions by Provenance
...
if(save_widgets){
  htmlwidgets::saveWidget(fig, file = paste0(lost_accessions_widget_dir,'/number_provenance.html'),selfcontained = T)
}
...
if(save_widgets){
  htmlwidgets::saveWidget(fig, file = paste0(lost_accessions_widget_dir,'/proportion_provenance.html'),selfcontained = T)
}
...
### Distribution and Number of Lost Accessions by Endemic Species
...
if(save_widgets){
  htmlwidgets::saveWidget(fig, file = paste0(lost_accessions_widget_dir,'/number_endemic.html'),selfcontained = T)
}
...
if(save_widgets){
  htmlwidgets::saveWidget(fig, file = paste0(lost_accessions_widget_dir,'/proportion_endemic.html'),selfcontained = T)
}
...
if(save_widgets){
  htmlwidgets::saveWidget(fig, file = paste0(lost_accessions_widget_dir,'/Bar_endemic_local.html'),selfcontained = T)
}
...
### Distribution and Number of Lost Accessions by Threatened Species
...
if(save_widgets){
  htmlwidgets::saveWidget(fig, file = paste0(lost_accessions_widget_dir,'/number_threatened.html'),selfcontained = T)
}
...
if(save_widgets){
  htmlwidgets::saveWidget(fig, file = paste0(lost_accessions_widget_dir,'/proportion_threatened.html'),selfcontained = T)
}
...
if(save_widgets){
  htmlwidgets::saveWidget(fig, file = paste0(lost_accessions_widget_dir,'/number_threatened_category.html'),selfcontained = T)
}
...
if(save_widgets){
  htmlwidgets::saveWidget(fig, file = paste0(lost_accessions_widget_dir,'/proportion_threatened_category.html'),selfcontained = T)
}
...
xlsx::saveWorkbook(wb, file = paste0(output_dir,'/',collection,'_data_for_figures_reterospective_lost_accessions.xlsx'))
```
