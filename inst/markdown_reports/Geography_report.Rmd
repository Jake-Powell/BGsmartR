...
if(export_data){
  save(location_data, file = paste0(collection,'_geography_data.rda'))
...
```{r, BRU level 3 areas represented in the LC - static figure, echo = FALSE, fig.fullwidth=FALSE, fig.dim = c(10, 6)}
...
```{r, BRU level 3 areas represented in the LC - interactive figure, echo = FALSE, fig.fullwidth=FALSE, fig.dim = c(10, 6)}
if(report_kind == 'interactive'){
