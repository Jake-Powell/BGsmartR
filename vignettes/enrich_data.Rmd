...
Once we have obtained the data we want to format it ready to be matched via BGSmartR. 
...
BGCI_plant_search = BGSmartR::prepare_enrich_database(BGCI_plant_search,
                                  enrich_taxon_name_column = 'taxon_names',
