...
Note that the current version of BGsmartR relies on old versions `gtsummary` and `downloadthis` (for report creating) these can be installed via the method below.
